...
<head>
	...
	<link rel="shortcut icon" href="/cerexserver/frontend/img/favicon.ico">
...
<body>
	...
	<ul class="tabrow"><!--- Tabs Menu -->
		...
		<li><a href="/cerexserver/backend/admin/admins.php">ADMINs</a></li>
		<li><a href="/cerexserver/backend/admin/trainer.php">TRAINERs</a></li>
